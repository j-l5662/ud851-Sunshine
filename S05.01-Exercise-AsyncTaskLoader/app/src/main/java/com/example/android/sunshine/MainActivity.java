...
//            String weatherURL = savedInstanceState.getString(WEATHER_EXTRA);
//
//        }
        //showWeatherDataView();
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            weatherBundle.putString(WEATHER_EXTRA,location);
            LoaderManager loaderManager = getSupportLoaderManager();
            Loader<String[]> weatherSearchLoader = loaderManager.getLoader(WEATHER_LOADER);
