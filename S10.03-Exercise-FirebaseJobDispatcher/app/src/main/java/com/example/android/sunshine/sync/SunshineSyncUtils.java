...
//  done (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int REMINDER_SYNC = 10800;
    private static final int REMINDER_INTERVAL = 3600;
    private static boolean sInitialized;

//  done (11) Add a sync tag to identify our sync job
    private static final String SYNC_TAG = "sunshine_sync_tag";
//  done (12) Create a method to schedule our periodic weather sync
    synchronized public static void scheduleWeatherSync(@NonNull final Context context){
        ...
        Job weatherupdate = dispatcher.newJobBuilder()
                .setService(SunshineFirebaseJobService.class)
                .setTag(SYNC_TAG)
                .setLifetime(Lifetime.FOREVER)
                .setTrigger(Trigger.executionWindow(REMINDER_SYNC,REMINDER_INTERVAL+REMINDER_SYNC))
                .setReplaceCurrent(true)
                .build();
        dispatcher.schedule(weatherupdate);
        sInitialized = true;
    }
    /**
